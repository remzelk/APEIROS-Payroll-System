  ...
  <div class="container-fluid h-100">
    <div class="row justify-content-center align-items-center h-100">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          <a href="/Admin/create" class="mb-4">+Add Announcement</a>
          <table class="table table-striped">
            ...
            <div class="scroll">
              ...
              <tr>
                ...
                <td class="align-middle"><a href="/Admin/{{ $announcement['id'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit announcement: <?php echo $announcement['Description'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
