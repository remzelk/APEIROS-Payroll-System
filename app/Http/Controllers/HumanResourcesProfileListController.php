...
class HumanResourcesProfileListController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('HumanResources.ProfileList.show')->with($data);
    }

    public function edit($id)
    {
        $profile = Profile::where('UserNo', $id)->firstOrFail();
        return view('HumanResources.ProfileList.edit')->with('profile', $profile);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $profile->update();
        return redirect('/HumanResources/ProfileList/' . $profile->UserNo);
    }
