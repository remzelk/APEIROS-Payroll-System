    ...
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          <a href="/HumanResources/Payroll">< <u>Payroll</u></a><br><br>
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Input Attendance</h3>
            <form action="/HumanResources/DigitalAttendance/{{ $payroll['UserNo'] }}" method="POST">
            @csrf
            @method('Put')
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" step="1" min="0" value="{{ $payroll['DaysWorked'] }}" id="DaysWorked" name="DaysWorked" class="form-control mb-4" required>
                </div>
                <div class="col-md-6">
                  <label>Night Shift Differential</label>
                  <input type="number" step="1" min="0" value="{{ $payroll['NSDifferential'] }}" id="NSDifferential" name="NSDifferential" class="form-control mb-4" required>
                </div>
                <div class="col-md-6">
                  <label>Special Holidays</label>
                  <input type="number" step="1" min="0" value="{{ $payroll['SHDays'] }}" id="SHDays" name="SHDays" class="form-control mb-4" required>
                </div>
                <div class="col-md-6">
                  <label>Legal Holidays</label>
                  <input type="number" step="1" min="0" value="{{ $payroll['LHDays'] }}" id="LHDays" name="LHDays" class="form-control mb-4" required>
                </div>
            </div>
              <div class="mt-4 pt-2">
