    ...
    <div class="row justify-content-center align-items-center h-100">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <a href="/Employee/AccountSettings/ChangeName" class="btn btn-info" style="background-image: url(https://i.imgur.com/6YuRxJA.png)">Change Name</a>
            <a href="/Employee/AccountSettings/ChangePassword" class="btn btn-info" style="background-image: url(https://i.imgur.com/6YuRxJA.png)">Change Password</a>
          </form>
        </div>
    </div>
  </div>
