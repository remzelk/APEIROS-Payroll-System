...
<nav id="mySidenav" class="sidenav">
  ...
  <ul class="nav flex-column" id="nav_accordion">
    ...
    <li class="nav-item"><a href="/Admin/ProfileList" class="active">Profile List</a></li>
            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                      ...
                      @endif
                        <form action="/Admin/ProfileList/{{ $profile['UserNo'] }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('Put')
                        <a href="/Admin/ProfileList">< Profile</a>
