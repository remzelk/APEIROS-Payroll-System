...
<nav id="mySidenav" class="sidenav">
  ...
  <li class="nav-item"><a href="/Chief">Home</a></li>
    ...
    <li class="nav-item"><a href="/Chief/BIRForm2316" class="active">BIR Form 2316</a></li>
        ...
        <div class="row justify-content-center align-items-center h-100">
            ...
            <div class="card-body p-4 p-md-5" style="width: 50rem;">
			    <h1>BIR Form 2316</h1><br>
                    <iframe src="{{ asset('bir/' . $bir['BIRForm']) }}" style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;">
