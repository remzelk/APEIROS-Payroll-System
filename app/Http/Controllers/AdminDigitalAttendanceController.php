...
class AdminDigitalAttendanceController extends Controller
{
    public function editattendance($paycode, $id)
    {
        ...
        return view('Admin.DigitalAttendance.edit')->with($data);   
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('Admin.DigitalAttendance.index')->with($data);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('Admin.DigitalAttendance.list')->with($data);
    }
