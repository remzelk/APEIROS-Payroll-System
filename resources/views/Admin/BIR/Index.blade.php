  ...
  <div class="container-fluid h-100">
    <div class="row justify-content-center align-items-center h-100">
      ...
      <form action="" method="get">
        ...
        <a href="/Admin/BIRForm2316/create" class="mb-4"><i class="fa fa-envelope"></i> Send BIR Form</a>&emsp;
		...
		<div class="scroll">
			...
			<div class="scroll">
				...
				<tr>
                    <td>{{ $bir['Year'] }}</th>
          			<td><a class="profile-name" href="/Admin/BIRForm2316/{{ $bir['Year'] }}">View</a></td>
        		</tr>
        		@empty
          <tr>
    		    <td colspan="2">
