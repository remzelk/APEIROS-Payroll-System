      ...
      <form action="" method="get">
        ...
        <tr>
          ...
          <td class="align-middle">
            <a href="/Admin/Credentials/Admin/{{ $user['userno'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit user: <?php echo $user['name'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
          </td>
          <form action="/Admin/Credentials/Admin/{{ $user['userno'] }}" method="POST">
          @csrf
          @method('Delete')
          <td class="align-middle">
