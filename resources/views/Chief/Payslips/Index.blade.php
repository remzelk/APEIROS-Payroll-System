...
<nav id="mySidenav" class="sidenav">
  ...
  <li class="nav-item"><a href="/Chief">Home</a></li>
    ...
    <li class="nav-item"><a href="/Chief/Payslips" class="active">Payslips</a></li>
			...
			<div class="scroll">
				...
				<tr>
					...
					<td class="text-left">{{ $payrollcode['End'] }}</td>
          			<td class="text-left"><a class="profile-name" target="_blank" href="/Chief/Payslips/{{ $payrollcode['PayCode'] }}">View</a></td>
        		</tr>
        		@empty
          <tr>
    		    <td colspan="4">
