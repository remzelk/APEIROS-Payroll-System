...
<div  id="main">
  <div class="container-fluid h-100">
    <div class="row justify-content-center align-items-center h-100">
      ...
      <a href="/HumanResources/Detachments/create" class="mb-4">+Add Detachment</a>&emsp;&emsp;
      <form action="" method="get">
        <div class="my-2 my-lg-0 right"> 
          ...
          <td class="align-middle">
            <a href="/HumanResources/Detachments/{{ $detachment['DCode'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit detachment: <?php echo $detachment['Detachment'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
          </td>
