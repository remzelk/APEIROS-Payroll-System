...
class AdminSSSController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Admin.Payroll.SSS.index')->with($data);
    }

    public function create()
    {
        return view('Admin.Payroll.SSS.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $sss->save();
        return redirect('/Admin/Payroll/SSS'); 
    }

    public function edit($id)
    {
        $sss = SSS::where('id', $id)->firstOrFail();
        return view('Admin.Payroll.SSS.edit')->with('sss', $sss);
    }
