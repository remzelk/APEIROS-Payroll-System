...
<nav id="mySidenav" class="sidenav">
  ...
  <li class="nav-item"><a href="/Chief">Home</a></li>
    ...
    <li class="nav-item"><a href="/Chief/AccountSettings" class="active">Account Settings</a></li>
    ...
    <div class="row justify-content-center align-items-center h-100">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          @endif
            ...
            <form method="POST" action="/Chief/AccountSettings/ChangeName/{{ Auth::user()->userno }}">
            @csrf
            @method('Put')
			      <div class="my-2 my-lg-0"> 
                <label for="name">Name</label>
    		    <input class="form-control mb-4" type="text" id="name" name="name" value="{{ Auth::user()->name }}" required>
            <button class="btn btn-info" type="submit" name="submit" id="submit" style="background-image: url(https://i.imgur.com/6YuRxJA.png)">Change Name</button>
          </form>
        </div>
    </div>
  </div>
