      ...
      <form action="" method="get">
        <div class="my-2 my-lg-0 right"> 
          ...
          <td class="align-middle">
            <a href="/Admin/Credentials/Employee/{{ $user['id'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit user: <?php echo $user['name'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
          </td>
          <form action="/Admin/Credentials/Employee/{{ $user['id'] }}" method="POST">
          @csrf
          @method('Delete')
          <td class="align-middle">
