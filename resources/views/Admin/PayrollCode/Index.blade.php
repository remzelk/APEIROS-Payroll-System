          ...
          <table class="table table-striped">
            ...
            <div class="scroll">
              ...
              <tr>
                ...
                <td class="align-middle"><a href="/Admin/PayrollCode/{{ $payrollcode['PayCode'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit payroll code: <?php echo $payrollcode['PayCode'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                <form action="/Admin/PayrollCode/{{ $payrollcode['PayCode'] }}" method="POST">
                  @csrf
                  @method('Delete')
