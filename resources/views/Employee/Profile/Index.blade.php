          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <img src="https://th.bing.com/th/id/R.3e77a1db6bb25f0feb27c95e05a7bc57?rik=DswMYVRRQEHbjQ&riu=http%3a%2f%2fwww.coalitionrc.com%2fwp-content%2fuploads%2f2017%2f01%2fplaceholder.jpg&ehk=AbGRPPcgHhziWn1sygs8UIL6XIb1HLfHjgPyljdQrDY%3d&risl=&pid=ImgRaw&r=0" alt="Employee" class="rounded-circle" width="150" height="150">
                @else
                <img src="{{ asset('images/' . $profile['Image'] )}}" alt="Employee" class="rounded-circle" width="150" height="150">
                @endif
                <div class="mt-3">
                  <h4>{{ Auth::user()->name }}</h4>
                  <h5>{{ Auth::user()->userno }}</h5>
                  <h6 class="text-secondary mb-1">{{ $profile['ContactNumber'] }}<h6>
                  <a href="/Employee/Profile/{{ Auth::user()->userno }}/edit" class="btn btn-info" onclick="return confirm('Edit Profile?')">Edit</a>
                </div>
              </div>
            </div>
          </div>
