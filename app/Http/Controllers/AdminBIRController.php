...
class AdminBIRController extends Controller
{
    public function view($id)
    {
        $bir = BIR::where('BIRForm', $id)->firstORFail();
        return view('Admin.BIR.view')->with('bir', $bir);
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('Admin.BIR.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('Admin.BIR.add')->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $bir->save();
        return redirect('/Admin/BIRForm2316');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $data = compact('bir', 'search');
        return view('Admin.BIR.show')->with($data);
    }
}
