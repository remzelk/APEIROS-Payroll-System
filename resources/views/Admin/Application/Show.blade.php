                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ asset('images/' . $application['Image'] )}}" alt="Employee" class="rounded-circle" width="150" height="150">
                                <div class="mt-3">
                                    <h5>{{ $application['NickName'] }}</h5>
                                    <p class="text-secondary mb-1"><b>Position:</b> {{ $application['Position'] }}</p><br>
                                    <h6 class="text-secondary mb-1">{{ $application['ContactNumber'] }}<h6>
                                    @if($application['ContactNumber2'] != "")
                                    {
                                        <h6 class="text-secondary mb-1">{{ $application['ContactNumber2'] }}<h6>
                                    }
                                    @endif
                                    @if($application['ContactNumber3'] != "")
                                    {
                                        <h6 class="text-secondary mb-1">{{ $application['ContactNumber3'] }}<h6>
                                    }
                                    @endif
                                    @if($application['ContactNumber4'] != "")
                                    {
                                        <h6 class="text-secondary mb-1">{{ $application['ContactNumber4'] }}<h6>
                                    }
                                    @endif
                                    <a href="/Admin/ApplicationList/{{ $application['userID'] }}/edit" class="btn btn-info" onclick="return confirm('Edit Application?')">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
                <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <span class="text-secondary">{{ $application['DateOfApplication'] }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">Date Hired</h6>
                            <span class="text-secondary">{{ $application['DateHired'] }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">Sex</h6>
                            <span class="text-secondary">{{ $application['Sex'] }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">Email</h6>
                            <span class="text-secondary">{{ $application['Email'] }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
