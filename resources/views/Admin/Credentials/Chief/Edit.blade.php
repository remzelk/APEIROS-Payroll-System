...
@endsection
@section('title', 'Chief Credentials (Edit)')
@section('content')
  ...
  <ul class="nav flex-column" id="nav_accordion">
    ...
    <a href="#" class="nav-link">Credentials <i class="fa fa-caret-down"></i></a>
        <ul class="submenu collapse">
          ...
          <li><a class="nav-item active" href="/Admin/Credentials/Chief">Chief</a></li>
    ...
    <li class="nav-item"><a href="/Admin/Detachmentss">Detachments</a></li>
  ...
  <div class="container py-5 h-100">
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-12 col-lg-9 col-xl-7">
        ...
        <form method="POST" action="/Admin/Credentials/Chief/{{ $user['id'] }}">
            @csrf
            @method('Put')
            <div class="row">
                <div class="col-md-6">
