      ...
      <form action="" method="get">
		...
		<div class="scroll">
			...
			<div class="scroll">
				...
				<tr>
                <td>{{ $bir['Year'] }}</th>
          			<td><a class="profile-name" target="_blank" href="/Chief/BIRForm2316/view/{{ $bir['BIRForm'] }}">View</a></td>
                <td><a class="profile-name" href="{{ route('chiefbir', $bir['BIRForm']) }}">Download</a></td>
        		</tr>
        		@empty
          <tr>
    		    <td colspan="3">
