...
<div  id="main">
  <div class="container-fluid h-100">
    <div class="row justify-content-center align-items-center h-100">
      ...
      <a href="/HumanResources/LeaveRequests/Archive" class="mb-4">Leave Requests Archive</a>&emsp;&emsp;
      <form action="" method="get">
        <div class="my-2 my-lg-0 right"> 
          ...
          <td class="align-middle">
            <a href="/HumanResources/LeaveRequests/{{ $leave['LeaveNo'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit leave: <?php echo $leave['LeaveNo'] ?>?')">Review</a>
          </td>
        @empty
    		  <td colspan="9">
            <h1>No Data!</h1>
