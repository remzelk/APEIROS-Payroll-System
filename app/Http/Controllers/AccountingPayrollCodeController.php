...
class AccountingPayrollCodeController extends Controller
{
    public function index()
    {
        ...
        return view('Accounting.PayrollCode.index')->with($data);
    }

    public function create()
    {
        return view('Accounting.PayrollCode.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $payrollcode->save();
        return redirect('/Accounting/PayrollCode')->with('message', 'Payroll code: ' . $payrollcode->PayCode . ' generated successfully!');
    }

    public function edit($id)
    {
        $payrollcode = PayrollCode::where('PayCode', $id)->firstOrFail();
        return view('Accounting.PayrollCode.edit')->with('payrollcode', $payrollcode);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $payrollcode->update();
        return redirect('/Accounting/PayrollCode')->with('message', 'Payroll code: ' . $payrollcode->PayCode . ' edited successfully!');
    }
    ...
    public function delete($id)
    {
        $payrollcode = PayrollCode::where('PayCode', $id)->firstOrFail();
        $payrollcode->delete();
        return redirect('/Accounting/PayrollCode');
    }
}
