  ...
  <div class="container-fluid h-100">
    <div class="row justify-content-center align-items-center h-100">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          <a href="/Accounting/Payroll" class="mb-4">< Payroll</a>
          <h1 class="mb-3">SSS Contribution Table</h1>
          <div class="mb-4">
            <a href="/Accounting/Payroll/SSS/create" class="mb-4">+Add Contribution</a>
          </div>
            ...
            <div class="scroll">
              ...
              <tr>
                ...
                <td class="align-middle">
					<a href="/Accounting/Payroll/SSS/{{ $sss['id'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit contribution: <?php echo 'Min: ' , $sss['Min'] , ', Max: ' , $sss['Max'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				</td>
				<td class="align-middle">
