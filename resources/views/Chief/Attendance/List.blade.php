			...
			<div class="scroll">
				...
				<tr>
					<td class="align-middle">
						<a href="/Chief/Attendance/{{$attendance['PayCode']}}/{{ $attendance['UserNo'] }}" class="btn btn-primary" onclick="return confirm('Edit employee: <?php echo $attendance['Name'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
					</td>
					<td>
						{{ $attendance['DCode'] }}
					</td>
