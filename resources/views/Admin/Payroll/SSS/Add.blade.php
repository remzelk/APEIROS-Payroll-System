    ...
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          <a href="/Admin/Payroll/SSS">< <u>SSS Contribution</u></a><br><br>
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add SSS Contribution</h3>
            <form action="/Admin/Payroll/SSS" method="POST">
            @csrf
            <div class="row">
            <div class="col-md-6">
              <label>Minimum</label>
              <input type="number" step="0.01" min="0" value="0.00" id="Min" name="Min" class="form-control mb-4" required>
            </div>
            <div class="col-md-6">
              <label>Maximum</label>
              <input type="number" step="0.01" min="0" value="0.00" id="Max" name="Max" class="form-control mb-4" required>
            </div>
            <div class="col-md-6">
              <label>Employee Contribution</label>
              <input type="number" step="0.01" min="0" value="0.00" id="Contribution" name="Contribution" class="form-control mb-4" required>
            </div>
          </div>
          <div class="mt-4 pt-2">
