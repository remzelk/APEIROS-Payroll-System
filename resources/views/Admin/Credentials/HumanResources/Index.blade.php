...
@endsection
@section('title', 'Human Resources Credentials')
@section('content')
    ...
    <div class="row justify-content-center align-items-center h-100">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
			<h1>Human Resources Credentials</h1><br>
      ...
      <form action="" method="get">
        <div class="my-2 my-lg-0 right"> 
          ...
          <td class="align-middle">
            <a href="/Admin/Credentials/HumanResources/{{ $user['userno'] }}/edit" class="btn btn-primary" onclick="return confirm('Edit user: <?php echo $user['name'] ?>?')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
          </td>
          <form action="/Admin/Credentials/HumanResources/{{ $user['userno'] }}" method="POST">
          @csrf
          @method('Delete')
          <td class="align-middle">
