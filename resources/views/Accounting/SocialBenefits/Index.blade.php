...
<nav id="mySidenav" class="sidenav">
  ...
  <ul class="nav flex-column" id="nav_accordion">
    ...
    <li class="nav-item"><a href="/Accounting/SocialBenefits" class="active">Social Benefits</a></li>
